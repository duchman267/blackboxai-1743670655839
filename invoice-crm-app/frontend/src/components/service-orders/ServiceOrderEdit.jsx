...
function ServiceOrderEdit() {
  ...
  const [serviceOrder, setServiceOrder] = useState({
    ...
    description: 'Regular maintenance check for office equipment',
  ...
  useEffect(() => {
    // In a real app, fetch service order data here
    // Example: fetchServiceOrder(id).then(data => setServiceOrder(data));
  }, [id]);

  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission here
    // After successful update, navigate back to service orders list
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Edit Service Order #{id}</h1>
      </div>
